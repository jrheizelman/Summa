...
| Function of valid_type * valid_type list | Undef | Ref_to_type of string * int
...
| Ref_to_type(s1, i1) -> (match t2 with Ref_to_type(s2, i2) -> s1 = s2 | _ -> false)
...
| Undef -> "undefined"
| Ref_to_type(s, i) -> "ref_to_type of id: " ^ s ^ ", " ^ string_of_int i
